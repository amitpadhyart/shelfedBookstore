...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_PAYMENT', 'PAYMENT_CONFIRMED', 'FULFILLED', 'CANCELLED');
...
CREATE TABLE "Order" (
    ...
    "guestLine1" TEXT NOT NULL,
    "guestLine2" TEXT,
    "guestCity" TEXT NOT NULL,
    "guestState" TEXT NOT NULL,
    "guestPincode" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "Book_mood_idx" ON "Book"("mood");
